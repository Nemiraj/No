...
detector = cv2.CascadeClassifier(r'C:\Users\91797\AppData\Local\Programs\Python\Python39\Lib\site-packages\cv2\data/haarcascade_frontalface_default.xml')
...
while True:
    ...
    #eye=detector1.detectMultiScale(converted_image,1.3, 5)
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite("samples/face." + str(face_id+name) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w])
